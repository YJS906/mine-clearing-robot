...
## GitHub Clone만으로 충분한가?

GitHub에서 이 repo를 clone한다고 해서 모든 dependency가 자동으로 설치되지는 않습니다.

이 repo에는 주로 직접 만든 vision grasp 패키지만 들어 있습니다. 아래 항목들은 새 PC에서 따로 설치하거나 clone해야 합니다.
